...
public class BlogResource {
	...
	/*
	 * public BlogResource(BlogRepository blogRepository, BlogSearchRepository
	 * blogSearchRepository) { this.blogRepository = blogRepository;
     ...
     */
	/*
	 * @GetMapping("/_search/blogs") public List<Blog> searchBlogs(@RequestParam
	 * String query) { log.debug("REST request to search Blogs for query {}",
	 * query); return StreamSupport
	 * .stream(blogSearchRepository.search(queryStringQuery(query)).spliterator(),
