...
public class TagResource {
	 ...
	 * 
	 * public TagResource(TagRepository tagRepository, TagSearchRepository
	 * tagSearchRepository) { this.tagRepository = tagRepository;
     ...
     */
	/*
	  @GetMapping("/_search/tags") public ResponseEntity<List<Tag>>
	  searchTags(@RequestParam String query, Pageable pageable, @RequestParam
	  ...
	  Page<Tag> page = tagSearchRepository.search(queryStringQuery(query),
