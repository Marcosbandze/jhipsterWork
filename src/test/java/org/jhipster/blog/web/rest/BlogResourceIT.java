...
public class BlogResourceIT {
   ...
   // private BlogSearchRepository mockBlogSearchRepository;
	...
	/*
	  ...
	  @Transactional public void searchBlog() throws Exception { // Initialize the
	  database blogRepository.saveAndFlush(blog);
	  when(mockBlogSearchRepository.search(queryStringQuery("id:" + blog.getId())))
	  .thenReturn(Collections.singletonList(blog)); // Search the blog
